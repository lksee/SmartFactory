...
namespace KFQS_Form
{
    ...
    public partial class MM_StockMMRec : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void MM_StockMMRec_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "INOUTWORKER", "입출 등록자", GridColDataType_emu.VarChar,         130, HAlign.Left,   true, false);
            _GridUtil.InitColumnUltraGrid(grid1, "PONO",        "발주 번호",   GridColDataType_emu.VarChar,         160, HAlign.Left,   true, false);
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                dtTemp = helper.FillTable("13MM_StockMMRec_S", CommandType.StoredProcedure
